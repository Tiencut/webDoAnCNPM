<template>
  <div class="weekly-plan-management-container">
    ...
    <button @click="showAddPlanModal" class="btn btn-primary add-plan-button">Thêm Kế hoạch Mới</button>
    ...
    <WeeklyPlanTable :plans="plans" @editPlan="editPlan" @deletePlan="deletePlan" />
  </div>
</template>
